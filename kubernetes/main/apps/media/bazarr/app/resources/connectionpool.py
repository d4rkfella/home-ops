...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    Always enables SSL certificate validation.
    """
    ...
    def __init__(
        ...
        cert_reqs: int | str | None = ssl.CERT_REQUIRED,  # Always validate certs
        key_password: str | None = None,
        ca_certs: str | None = None,
        ssl_version: int | str | None = None,
        ssl_minimum_version: ssl.TLSVersion | None = None,
        ssl_maximum_version: ssl.TLSVersion | None = None,
        assert_hostname: bool | str | None = None,
        ...
        **conn_kw: typing.Any,
        ...
        # Initialize SSL-related arguments
    ...
    def _new_conn(self) -> HTTPSConnection:
        ...
        Always enforces certificate validation.
        """
        self.num_connections += 1
        log.debug(
        ...
        # Create the HTTPS connection, enforcing certificate validation
        return self.ConnectionCls(
            ...
            cert_reqs=ssl.CERT_REQUIRED,  # Ensure always verifying certificates
    ...
    def _validate_conn(self, conn: HTTPSConnection) -> None:
        """
        Called right before a request is made, after the socket is created.
        Always enforces SSL verification.
        """
        super()._validate_conn(conn)

        # Force connection early to allow us to validate the connection.
        if conn.is_closed:
            conn.connect()

        # Always ensure certificate verification is done and show warning if not verified
